  ...
  return (
    <GameModal isOpen={props.isOpen} onClose={() => {}}>
      <div className="flex flex-col items-center justify-center px-10 gap-4">
        <h1 className="font-heading text-3xl text-wedding-aubergine">
          Enter your name
        </h1>

        <p className="text-wedding-blush text-center">
          (Or a team name, e.g. “Table 7”)
        </p>

        <input
          className="w-full max-w-sm rounded-md px-4 py-3 bg-wedding-blush text-wedding-aubergine outline-none"
